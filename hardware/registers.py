...
class XM:
    ...
    RATE_A = {'PD':(0b0000) << 4, '3.125HZ':(0b0001 << 4),'6.25HZ':(0b0010 << 4), '12.5HZ':(0b0011 << 4), \
               '25HZ':(0b0100 << 4),'50HZ':(0b0101 << 4),'100HZ':(0b0110 << 4),'200HZ':(0b0111 << 4),'400HZ':(0b1000 << 4),\
               '800HZ':(0b1001 << 4),'1600HZ':(0b1010 << 4)}
